...
- **[1v1](/appendices/glossary#_1v1-one-on-one-duel) (Duel)**: Two bots face off in direct combat. The most popular
  competitive format. Success depends on targeting accuracy and energy management.
- **[Melee](/appendices/glossary#melee)**: Three or more bots battle simultaneously until one remains. Survival
  often matters more than raw damage
  output. *(Fun fact: The name "Tank Royale" is inspired by melee battles resembling the "Battle Royale" game genre!)*
- **[Team](/appendices/glossary#team)**: Multiple bots per side share a collective score. Enables role
  specialization and coordinated tactics.
...
- Has the **[RoboRumble](/appendices/glossary#roborumble) client built-in** for participating in community rankings
...
- Does not have a community competition system like RoboRumble and
  [LiteRumble](/appendices/glossary#literumble) yet.
