...
<!-- TODO: Illustration -->
<!-- A top-down diagram on a dark grid background.
     - Use a light gray battlefield rectangle.
     - Draw the shooter bot as a blue square at the left.
     - Draw the enemy bot as an orange square ahead and slightly above.
     - Show the enemy's current velocity as an orange arrow continuing in a straight line.
     - Show the predicted intercept point as a highlighted orange circle.
     - Draw the bullet path from the shooter to the intercept point as a yellow line.
     - Add labels: dx/dy, v, bullet speed, and 't turns'. -->
